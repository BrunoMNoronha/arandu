// --- DADOS E CONFIGURAÇÕES GLOBAIS ---
        ...
        class Joystick {
            ...
            activate(pointer) { if (this.scene.isTargetingAbility) return; this.pointer = pointer; this.base.setPosition(pointer.x, pointer.y).setVisible(true); this.thumb.setPosition(pointer.x, pointer.y).setVisible(true); } // NOVO: Bloqueia joystick durante mira
        ...
        class Enemy extends Phaser.Physics.Arcade.Sprite {
            ...
            update(time, delta) { if (!this.active || !this.scene.player.active || this.scene.isTargetingAbility) { this.body.setVelocity(0,0); return; } this.runAI(time); this.updateHealthBar(); this.stunEffect.setPosition(this.x, this.y - this.height).setVisible(this.getData('isStunned')); } // NOVO: Pausa IA durante mira
        ...
        class DungeonScene extends Phaser.Scene {
            ...
            update(time, delta){
                ...
                if (this.isTargetingAbility) {
                    ...
                    this.player.body.setVelocity(0); // Para o jogador enquanto mira
                    return; // Pula o resto da lógica de update
                }
